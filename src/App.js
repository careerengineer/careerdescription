...
const CareerStatementGenerator = () => {
  ...
  const generateWordDocument = () => {
    ...
    html += '<p style="text-align:center;margin-top:20px;color:#666;font-size:12px">© 2025 CareerEngineer All Rights Reserved. 이 문서는 저작권법에 의해 보호받는 저작물입니다. 문서의 전체 또는 일부를 저작권자의 사전 서면 동의 없이 무단으로 복제, 배포, 전송, 전시, 방송하거나 수정 및 편집하는 행위는 금지되어 있으며, 위반 시 관련 법령에 따라 법적인 책임을 질 수 있습니다. 오직 개인적인 용도로만 사용해야 하며, 상업적 목적의 사용 및 무단 배포를 엄격히 금지합니다.</p>';
    html += '</body></html>';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200 text-center text-sm text-gray-600">
            <p>© 2025 CareerEngineer All Rights Reserved. 이 문서는 저작권법에 의해 보호받는 저작물입니다. 문서의 전체 또는 일부를 저작권자의 사전 서면 동의 없이 무단으로 복제, 배포, 전송, 전시, 방송하거나 수정 및 편집하는 행위는 금지되어 있으며, 위반 시 관련 법령에 따라 법적인 책임을 질 수 있습니다. 오직 개인적인 용도로만 사용해야 하며, 상업적 목적의 사용 및 무단 배포를 엄격히 금지합니다.</p>
          </div>
        </div>
      </div>
    </div>
